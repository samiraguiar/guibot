...
class ChainTest(unittest.TestCase):
    ...
    def test_stepsfile_lookup(self):
        ...
        """
        tmp_dir = mkdtemp()
        tmp_steps_file = f"{tmp_dir}/{self.stepsfile_missing}.steps"
    ...
    def test_step_save(self):
        ...
        stepsfile_contents = [
            ...
            "item_for_tempfeat.png	some_tempfeat_matchfile.match",
            "item_for_feature.png	some_feature_matchfile.match",
            f"{deep_pth}	some_deep_matchfile.match",
            f"{cascade_xml}	some_cascade_matchfile.match",
            "item_for_template.png	some_template_matchfile.match",
            "item_for_autopy.png	some_autopy_matchfile.match",
            f"{os.path.splitext(text_file)[0]}	some_text_matchfile.match",
        ...
        expected_content = [
            ...
            f"{os.path.splitext(deep_pth)[0]}.pth	{os.path.splitext(deep_pth)[0]}.match",
            f"{os.path.splitext(cascade_xml)[0]}.xml	{os.path.splitext(cascade_xml)[0]}.match",
            "item_for_template.png	item_for_template.match",
            "item_for_autopy.png	item_for_autopy.match",
            f"{os.path.splitext(text_file)[0]}.txt	{os.path.splitext(text_file)[0]}.match",
